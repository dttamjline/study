...
$('.p-in-numbers__chart .c-chart__item--i02 .number_small > span').html(myChart.data.datasets[0].data[3]);
...
$('.modal__chart01 .c-chart__item--i02 .number_small > span').html(myChart.data.datasets[0].data[3]);
...
$('.modal__chart02 .c-chart__item--i02 .number_small > span').html(myChart.data.datasets[0].data[3]);
...
$('.modal__chart03 .c-chart__item--i02 .number_small > span').html(myChart.data.datasets[0].data[3]);
